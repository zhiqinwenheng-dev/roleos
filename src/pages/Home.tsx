...
export default function Home() {
  ...
  return (
    <div className="pt-24">
      <section className="px-4 sm:px-6 lg:px-8 py-20 lg:py-32 max-w-7xl mx-auto text-center">
        <motion.div
        ...
        >
          ...
          <p className="text-xl text-black/60 max-w-3xl mx-auto mb-10">{t('hero_subtitle')}</p>
        ...
        <motion.div
          ...
          className="mt-20 relative rounded-2xl overflow-hidden border border-black/5 shadow-2xl bg-zinc-50 aspect-video flex items-center justify-center"
        >
          ...
          <div className="relative z-10 flex flex-col items-center">
            <div className="flex space-x-4 mb-8">
              {['Role', 'Kit', 'Team'].map((item) => (
                <div
                  key={item}
                  className="w-16 h-16 bg-white rounded-xl shadow-sm border border-black/5 flex items-center justify-center font-bold text-black/70"
                >
                  {item}
                </div>
              ))}
            </div>
            <div className="h-1 w-48 bg-black/5 rounded-full overflow-hidden">
              <motion.div
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-black/50">
            {isZh
              ? 'RS 与 Rc 属于同一个 RoleOS 平台，只是交付方式和运维边界不同。'
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="p-10 rounded-3xl border border-black/5 bg-white flex flex-col justify-between">
            <div>
              ...
              <h3 className="text-3xl font-bold text-black mb-4">{isZh ? '自托管私有部署' : 'Self-Hosted Deployment'}</h3>
              ...
              <ul className="space-y-4 mb-10">
                {(isZh
                  ? ['一次性购买（¥199）', '支持 Windows / macOS / Linux', '可接入自有模型与飞书', '完整 Role / Kit / Team 工作流']
                  : ['One-time purchase (¥199)', 'Windows / macOS / Linux support', 'Bring your own model and Feishu', 'Full Role / Kit / Team workflow']
                ).map((item, i) => (
          ...
          <div className="p-10 rounded-3xl bg-black text-white flex flex-col justify-between">
            <div>
              ...
              <ul className="space-y-4 mb-10">
                {(isZh
                  ? ['3 天免费试用', 'BYOM 免费持续使用', 'Managed Model ¥39/月', '内置租户隔离与运行审计']
                  : ['3-day free trial', 'BYOM free after trial', 'Managed Model ¥39/mo', 'Tenant isolation and run audit built in']
                ).map((item, i) => (
              ...
              <div className="space-y-8">
                {[
                  ...
                  },
                  {
                    step: '02',
                    title: 'Role',
                    desc: isZh ? '匹配可执行该任务的角色。' : 'Selects the role for the job.'
                  },
                  {
                    step: '03',
                    title: 'Kit',
                    desc: isZh ? '启用工具与执行模板。' : 'Enables tools and run templates.'
                  },
                  {
                    step: '04',
                    title: 'Team',
      ...
      <section className="py-24 bg-black text-white text-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            >
              {isZh ? '下载 RS 自托管' : 'Get RS Self-Hosted'}
            </Link>
            <Link
              to="/app/cloud"
